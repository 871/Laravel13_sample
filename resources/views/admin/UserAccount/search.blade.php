...
/** @var App\Domain\User\UserAccounts\Entity\AccountStatusMaster[] $accountStatusOptions */
                ...
                <tr>
                    <th>
                        <a href="{{ route('admin.user_account.search.index', [
                            'account_id' => request()->route('account_id'),
                            'sort' => 'user_accounts.id',
                            'direction' => request('sort') === 'user_accounts.id' && request('direction') === 'ASC' ? 'DESC' : 'ASC',
                        ] + request()->query()) }}">ID</a>
                    </th>
                    <th>
                        <a href="{{ route('admin.user_account.search.index', [
                            'account_id' => request()->route('account_id'),
                            'sort' => 'user_accounts.email',
                            'direction' => request('sort') === 'user_accounts.email' && request('direction') === 'ASC' ? 'DESC' : 'ASC',
                        ] + request()->query()) }}">メール</a>
                    </th>
                    <th>
                        <a href="{{ route('admin.user_account.search.index', [
                            'account_id' => request()->route('account_id'),
                            'sort' => 'user_accounts.name',
                            'direction' => request('sort') === 'user_accounts.name' && request('direction') === 'ASC' ? 'DESC' : 'ASC',
                        ] + request()->query()) }}">名前</a>
                    </th>
                    <th>
                        <a href="{{ route('admin.user_account.search.index', [
                            'account_id' => request()->route('account_id'),
                            'sort' => 'user_accounts.account_status_master_id',
                            'direction' => request('sort') === 'user_accounts.account_status_master_id' && request('direction') === 'ASC' ? 'DESC' : 'ASC',
                        ] + request()->query()) }}">ステータス</a>
                    </th>
                    <th>
                        <a href="{{ route('admin.user_account.search.index', [
                            'account_id' => request()->route('account_id'),
                            'sort' => 'user_accounts.is_email_verified',
                            'direction' => request('sort') === 'user_accounts.is_email_verified' && request('direction') === 'ASC' ? 'DESC' : 'ASC',
                        ] + request()->query()) }}">メール確認</a>
                    </th>
                    <th>
                        <a href="{{ route('admin.user_account.search.index', [
                            'account_id' => request()->route('account_id'),
                            'sort' => 'user_accounts.password_changed_at',
                            'direction' => request('sort') === 'user_accounts.password_changed_at' && request('direction') === 'ASC' ? 'DESC' : 'ASC',
            ...
            @foreach($searchResults['data'] as $row)
                <tr>
                    ...
                    <td class="text-nowrap">
                        <a href="{{ route(
                            'admin.user_account.detail.index',
                            array_merge(
                                request()->query(),
                                [
                                    'account_id' => request()->route('account_id'),
                        ...
                        <a href="{{ route(
                            'admin.user_account.create.copy',
                            array_merge(
                                request()->query(),
                                [
                                    'account_id' => request()->route('account_id'),
